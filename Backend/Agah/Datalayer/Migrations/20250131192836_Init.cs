        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlarmPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPhoneVerivied = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductLog_Product_Product_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reserve_Alarm_Alarm_Id",
                        column: x => x.Alarm_Id,
                        principalTable: "Alarm",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Reserve_Product_Product_Id",
                        column: x => x.Product_Id,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductLog_Product_Id",
                table: "ProductLog",
                column: "Product_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Reserve_Alarm_Id",
                table: "Reserve",
                column: "Alarm_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Reserve_Product_Id",
                table: "Reserve",
                column: "Product_Id");
