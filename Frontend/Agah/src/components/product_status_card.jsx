...
const product_status_card = ({ name, amount, changedPercent, changedAmount }) => {
    return (
        ...
        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            ...
            <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">قیمت : <span className='font-bold text-xl text-gray-200'>{amount}</span></p>
