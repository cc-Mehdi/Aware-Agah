...
const toastr = ({ toastrType, title }) => {
    ...
    return (
        <div
            className="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-200 dark:bg-gray-600 fixed top-0 mt-10"
            role="alert"
        >
            {getIcon()}
            ...
            <button
                type="button"
                className="ms-auto cursor-pointer -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
                aria-label="Close"
